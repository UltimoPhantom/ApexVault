...
const StockDetail = ({ name, price, id, quantity, LTP }) => {
  ...
  return (
    <div className='center justify-center mx-4 group mb-4'>
      <div className="block max-w-2xl p-6 bg-white border border-gray-200 rounded-3xl shadow-xl drop-shadow-2xl hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:rounded-xl transition-all duration-300 hover:shadow-none min-w-fit mb-4">
